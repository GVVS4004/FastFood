...
export default function OrderCard(props) {
  ...
  return (
    <figure class="snip1396 green">
      <img src={props.order.img} alt="pr-sample13" style={{ height: "485px", width: "100%" }} />
      <div class="image">
        <img src={props.order.img} alt="pr-sample13" style={{ height: "400px", width: "100%" }} />
      </div>
      <figcaption>
        <h3>{props.order.name}</h3>
        <p>{props.order.description}</p>
        <div className="container w-100" style={{ paddingLeft: "0px", marginBottom: "0%" }}>
          <select className="m-2 h200 bg-warning rounded" style={{ marginRight: "0px" }}>
          ...
          <select className="m-3 h200 bg-danger rounded" style={{ marginLeft: "0px" }}>
